  ...
  return (
    <footer className="bg-surface border-t border-gray-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-gray-400">
            <span className="font-mono">
              <span className="text-gray-600">{'/*'}</span> {currentYear} Levon Melkonyan{' '}
              <span className="text-gray-600">{'*/'}</span>
            </span>
            <span className="hidden sm:inline text-gray-600">|</span>
            <div className="flex gap-4">
              <Link to="/links" className="hover:text-accent transition-colors">
                Inspiration
              </Link>
        ...
        {/* ASCII art footer decoration */}
        <div className="mt-6 pt-6 border-t border-gray-800 text-center">
          <pre className="font-mono text-xs text-gray-700 select-none">
