    ...
    <div className="min-h-screen py-12 px-12 sm:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-16">
          ...
          <div className="text-surface space-y-5 text-base leading-relaxed">
            <p>
              Of course, this still isn't a perfect solution. One of the biggest hurdles I ran into is that this is much more of a mechanical nightmare than I imagined. For one, the optical alignment window of the OPT101 photodiode-amplifier sensors is tiny, which makes the break-beam setup extremely sensitive to positioning changes, even by a single millimeter. While this was tackled with a ton of wasted 3D printer filament and lots of hot glue, the actual string vibrations still posed an issue. For the printed housing, I made sure to cover each break-beam light path with as much plastic as possible to block ambient light, and wrapped each LED with electrical tape to concentrate the light onto the string. Even with all these optimizations, the D and G strings turned out to be much thinner than I had imagined, and their vibrations are physically very minimal at the bridge. My next iteration will be moved to right under the end of the fretboard instead, where the strings tend to vibrate more on average, making their amplitude stronger across the optical windows.
            </p>
            <p>
              Overall, the project works as an MVP, but it's far from being a usable product. More research needs to be done on optimizing the pitch detection and classification, and it might be worth considering the ML approach again. While having the whole product work with just the photodiode-amplifier sensors would be nice, other sensors are always on the table, and if I find a way to reliably mount piezoelectric sensors, that would make for a much cleaner waveform. Finally, I'll be redesigning the whole enclosure to sit at the top of the bass body for maximum string vibration. If you have any other ideas or would like to discuss this work with me, don't hesitate to reach out!
            </p>
