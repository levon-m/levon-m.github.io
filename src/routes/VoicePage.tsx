    ...
    <div className="min-h-screen py-12 px-12 sm:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-0">
          ...
          <div className="text-surface space-y-5 text-base leading-relaxed">
            <p>
              I've been involved with this project since my time at Cal Poly, where it started out as a school-funded research project called "Mapping For Social Justice". Our idea was to allow users to upload media to a webpage, and to archive the location of the media on a <a href="https://www.mapbox.com/" target="_blank" rel="noopener noreferrer" className="text-accent hover-slant">visual map</a>, letting other visitors browse and view this media. Privacy is a core focus of our work, so we first built facial anonymization by detecting faces with <a href="https://yolov8.com/" target="_blank" rel="noopener noreferrer" className="text-accent hover-slant">YOLOv8</a> and applying <a href="https://en.wikipedia.org/wiki/Gaussian_blur" target="_blank" rel="noopener noreferrer" className="text-accent hover-slant">Gaussian blur</a> with <a href="https://opencv.org/" target="_blank" rel="noopener noreferrer" className="text-accent hover-slant">OpenCV</a> upon user media upload. We also extended the pipeline to vocal privacy by using <a href="https://github.com/openai/whisper" target="_blank" rel="noopener noreferrer" className="text-accent hover-slant">Whisper</a> for transcriptions/captions and <a href="https://en.wikipedia.org/wiki/Voice_activity_detection" target="_blank" rel="noopener noreferrer" className="text-accent hover-slant">VAD</a> to isolate speech segments for anonymization via pitch/formant shifting. A major part of this work was balancing strong privacy protections with processing speed, since these transformations can be expensive at upload time. It was a joint collaboration between the computer science and architecture departments, where we initially wanted to use tools that aren't too technical like <a href="https://situ.nyc/research/projects/codec-collaborative-tool" target="_blank" rel="noopener noreferrer" className="text-accent hover-slant">Codec</a> to do the mapping, but realized having our own open-source platform would streamline the whole process. Research was also done on automatically mapping the locations of media with its extracted metadata, but this didn't prove too feasible for the time being. Manual mapping works just fine, but we are still looking into ways to at least partially automate the process.
            </p>
