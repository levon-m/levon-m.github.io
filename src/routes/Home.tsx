        ...
        <section className="mb-16">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-6 md:items-center">
            ...
            <div className="text-surface space-y-5 text-base leading-relaxed flex-1">
              ...
              <p>
                I play bass guitar, produce electronic music, and create tools that make real-time music performance more intuitive. My work draws on research in human-computer interaction, music information retrieval, pitch tracking for low-register instruments, and embedded ML for real-time systems. Through interdisciplinary work across software, electrical, and mechanical engineering, modern computational techniques, and creative practice, I hope to develop more expressive and engaging tools for making and performing music.
              </p>
              <p>
                I hold a BSc in Computer Science from <a href="https://www.calpoly.edu/" target="_blank" rel="noopener noreferrer" className="underline text-accent hover:italic">Cal Poly SLO</a>, with additional MSc-level coursework completed during an exchange program at <a href="https://www.chalmers.se/en/" target="_blank" rel="noopener noreferrer" className="underline text-accent hover:italic">Chalmers University of Technology</a> in Gothenburg, Sweden. I am also an incoming MSc student in Sound and Music Computing at <a href="https://www.upf.edu/en/" target="_blank" rel="noopener noreferrer" className="underline text-accent hover:italic">Universitat Pompeu Fabra</a> in Barcelona, Spain, beginning Fall 2026.
              </p>
              <p>
                Since graduating in 2024, I've been building real-time embedded systems full-time at <a href="https://ckt.com/" target="_blank" rel="noopener noreferrer" className="underline text-accent hover:italic">CK Technologies, Inc.</a> I've also been involved with non-profit work at<a href="https://www.studiovoice.org/" target="_blank" rel="noopener noreferrer" className="underline text-accent hover:italic">VOICE</a>, collaborating between both architects and software engineers. I led the development of an installation exploring the relationship between social justice in modern media and urban design for the 2025 <a href="https://timespaceexistence.com/" target="_blank" rel="noopener noreferrer" className="underline text-accent hover:italic">Time Space Existence Biennale</a> in Venice, Italy. I've also guest lectured for ARCH 498 at the <a href="https://www.washington.edu/" target="_blank" rel="noopener noreferrer" className="underline text-accent hover:italic">University of Washington</a> regarding our work.
              </p>
              <p>
                Take a look at my <Link to="/bookmarks" className="underline text-accent hover:italic">bookmarks</Link> for a collection of interesting writing, media, tools, and other personal sources of inspiration. I'm always looking for new people to collaborate with, so don't hesitate to reach out!
              </p>
